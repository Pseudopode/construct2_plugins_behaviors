...
(function ()
{
	...
	instanceProto.onCreate = function()
	{
		...
		this.elem.onclick = (function (self) {
			return function() {
				self.runtime.trigger(cr.plugins_.HTML_Img_Pode.prototype.cnds.OnClicked, self);
			};
		})(this);

		this.elem.ondblclick = (function (self) {
			return function() {
				self.runtime.trigger(cr.plugins_.HTML_Img_Pode.prototype.cnds.OnDoubleClicked, self);
			};
		})(this);
