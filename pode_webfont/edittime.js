function GetPluginSettings()
{
	return {
		...
		"id":			"WebFont",
		"version":		"1.0",
		"description":	"Load and display a webfont",
		"author":		"JP Deblonde",
		"help url":		"",
...
var property_list = [
	new cr.Property(ept_text,	"Text",					"OK",		"The initial text for the text box."),
	...
	new cr.Property(ept_text,	"URL of CSS File (<b>Preview mode only</b>)", "style.css", "URL of the CSS file <b>FOR THE PREVIEW MODE ONLY</b>."),
	new cr.Property(ept_text,	"CSS File name", "style.css", "The name of the css file."),
	new cr.Property(ept_text,	"HTML tag", "p", "HTML tag around webfont text."),
	new cr.Property(ept_text,	"HTML tag id", "myp", "tag id around webfont text.")
	];
